...
| Image & file uploads | UploadThing (Cloudinary when you need resizing/transforms) | Hosting, [CDN](./glossary.md#cdn) delivery, and resizing images yourself burns storage, bandwidth, and a weekend. | [UploadThing docs](https://docs.uploadthing.com) |
...
| Scaling & servers | [Serverless](./glossary.md#serverless) / backend-as-a-service (Cloudflare Workers, Supabase) | Let the platform add capacity on demand instead of provisioning, load-balancing, and babysitting servers. | [Cloudflare Workers docs](https://developers.cloudflare.com/workers/) |
